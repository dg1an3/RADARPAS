...
theWheelApp::InitInstance() {
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(oDocument),
		RUNTIME_CLASS(oMainFrame),       // main SDI frame window
		RUNTIME_CLASS(oView));
...
void 
AboutTheWheelDlg::DoDataExchange(CDataExchange* pDX) {
